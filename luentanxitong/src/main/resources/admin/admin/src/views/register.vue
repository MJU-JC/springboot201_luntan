<template>
    <div style="backgroundImage: url('/luentanxitong/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">论坛系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="版主姓名" class="input" v-if="tableName=='banzhu'">
                            <el-input v-model="ruleForm.banzhuName" autocomplete="off" placeholder="版主姓名"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='banzhu'">
                            <el-input v-model="ruleForm.banzhuPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='banzhu'">
                            <el-input v-model="ruleForm.banzhuEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.banzhuName)&& 'banzhu'==this.tableName){
                                this.$message.error('版主姓名不能为空');
                                return
                            }
                             if('banzhu' == this.tableName && this.ruleForm.banzhuPhone&&(!this.$validate.isMobile(this.ruleForm.banzhuPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('banzhu' == this.tableName && this.ruleForm.banzhuEmail&&(!this.$validate.isEmail(this.ruleForm.banzhuEmail))){
